				...
				<div class="agileinfo-ads-display col-lg-9">
					<div class="wrapper">
						...
						<div class="product-sec1 px-sm-4 px-3 py-sm-5  py-3 mb-4">
							<h3 class="heading-tittle text-center font-italic">Dòng điện thoại mới</h3>
							<div class="row">
										...
										<div class="men-thumb-item text-center">
											...
											<div class="men-cart-pro">
												<div class="inner-men-cart-pro">
													<a href="single.html" class="link-product-add-cart">Xem nhanh</a>
												</div>
											</div>
										</div>
			...
			<div class="row">
					...
					<div class="join-agile text-left p-4">
						<div class="row">
							<div class="col-sm-7 offer-name">
								...
								<h4 class="mt-2 mb-3">Tai nghe thương hiệu</h4>
								<p>Khuyến mãi tới 25%</p>
							</div>
				...
				<div class="col-lg-6 mt-lg-0 mt-5">
					<div class="join-agile text-left p-4">
						<div class="row ">
							<div class="col-sm-7 offer-name">
								<h6>Điện thoại lớn hơn</h6>
								<h4 class="mt-2 mb-3">Smart Phones 5</h4>
								<p>Miễn phí vận chuyển với hóa đơn trên 100$</p>
							</div>
							<div class="col-sm-5 offerimg-w3l">
