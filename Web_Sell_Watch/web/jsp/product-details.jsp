                            ...
                            <div class="product-info">
                                ...
                                <ul class="single-add-actions">
                                    ...
                                    <li class="add-to-compare">
                                        <div class="compare-button"><a href="compare.htm"><i class="icon-refresh"></i> Compare</a></div>
                                    </li>
                                </ul>
                                <ul class="stock-cont">
                                    <li class="product-sku">Sku: <span>${p.Categories.catId}</span></li>
                                    <li class="product-stock-status">Categories: <a href="#">${p.Categories.catName}</a></li>
